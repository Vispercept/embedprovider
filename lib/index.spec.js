...
describe('embedprovider', () => {
  ...
  describe('map providers', () => {
    it('t.co should be mapped to twitter.com', () => {
      expect(embedprovider('<html><script src="https://asdfasdf.afdfasdfadf.t.co" /></html>')).to.deep.equal({ domain: 'twitter.com', provider: 'twitter' });
    });
    it('map should be extendable', () => {
      ...
      expect(
        embedprovider('<html><script src="https://asdfasdf.afdfasdfadf.mystr.com" /></html>', { customProviderMap }),
